...
- name: Box Get Legal Hold Policy Assignment
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/documents/master/_listings/box/legal-hold-policy-assignments-assignment-id-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/documents/master/_listings/box/legal-hold-policy-assignments-assignment-id-get-postman.md
x-common:
- type: x-base
